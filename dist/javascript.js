// Initialize Firebase
var config = {
  apiKey: "AIzaSyAnZBTIUYKNLQese45CQYVdWTOlGKHH0oE",
  authDomain: "my-first-project-a3f70.firebaseapp.com",
  databaseURL: "https://my-first-project-a3f70.firebaseio.com",
  projectId: "my-first-project-a3f70",
  storageBucket: "my-first-project-a3f70.appspot.com",
  messagingSenderId: "775629071778"
};
...
$("#root").on('click', '#chat-send', function() {
  if ($("#chat-input").val() !== "") {
 ...
 $("#root").on('keypress', '#chat-input', function(e) {
 ...
 $("#root").on("click", ".cell", function() {
  console.log("click");

   // Grabs text from cell choice
  var clickChoice = $(this);
